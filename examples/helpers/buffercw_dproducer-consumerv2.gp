...
set terminal png
set output 'buffercw_dproducer-consumerv2.png'
...
set title "Cycles locked (buffer)"
set ylabel "cycles"
...
plot "buffer_cw_3p.dat" u (1):1,  \
     "buffer_cw_4p.dat" u (2):1,  \
     "buffer_cw_8p.dat" u (3):1,  \
     "buffer_cw_16p.dat" u (4):1, \
     "buffer_cw_32p.dat" u (5):1, \
     "buffer_cw_64p.dat" u (6):1, \
