...
set terminal png
set output 'consumercw_dproducer-consumerv2.png'
...
plot "consumer_cw_3p.dat" u (1):1,  \
     "consumer_cw_4p.dat" u (2):1,  \
     "consumer_cw_8p.dat" u (3):1,  \
     "consumer_cw_16p.dat" u (4):1, \
     "consumer_cw_32p.dat" u (5):1, \
     "consumer_cw_64p.dat" u (6):1, \
