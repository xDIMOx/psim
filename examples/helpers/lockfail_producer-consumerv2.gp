...
system('${HELPERS}/lockfail_helper.awk "lockfail_10_13.csv" "lockfail_((val&1)==0?9+(rand()&7):9-(rand()&7))_1+(rand()&1023).csv" "lockfail_1+(rand()&1023)_1+(rand()&1023).csv" "lockfail_1+(rand()&1023)_((item&1)==0?9+(rand()&7):9-(rand()&7)).csv"')
