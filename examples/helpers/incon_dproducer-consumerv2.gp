...
set terminal png
set output 'incon_dproducer-consumerv2.png'
...
set title "Avg. time waiting for input commands to finish (consumers)"
set ylabel "cycles"
set xlabel "processors"

plot "incon_10_13.csv" u 1:2 w linesp lw 3 title "static", \
